...
if __name__ == "__main__":
    ...
    if args.distill_type != "base":
        prefix = f"{ckpt_dir}/models/{args.teacher_model_name}/{args.teacher_model_adapter_name}/{args.teacher_model_ckpt}/distill/{args.distill_dataset_name}/{args.distill_sae_hookpoint}/{args.distill_type}"
    else:
        prefix = f"{ckpt_dir}/models/{args.student_model_name}/base/distill/{args.distill_dataset_name}/{args.distill_sae_hookpoint}"

    if args.distill_type == "sft_qwen_math" or args.distill_type == "sft_qwen":
        # mixed adapter evaluation
        student_model_name = f"{ckpt_dir}/models/{args.teacher_model_name}/base"
    else:
